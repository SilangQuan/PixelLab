...
// Right handed
bool Matrix3::LookRotationToMatrix(const Vector3& viewVec, const Vector3& upVec, Matrix3* m)
{
	...
	if (!Mathf::CompareApproximately(y.sqrtMagnitude(), 1.0F))
		return false;
...
/*
Matrix4x4 Matrix4x4::FPSView(const Vector3& eye, Quaternion rotation)
{
