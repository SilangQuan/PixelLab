...
bool ParticleSystem::InitParticleSystem(const Vector3& Pos)
{
    ...
    Particles[0].Pos = Pos;
    Particles[0].Vel = Vector3(0.0f, 0.0001f, 0.0f);
...
void ParticleSystem::Render(int DeltaTimeMillis, const Matrix4x4& VP, const Vector3& CameraPos)
{
...
void ParticleSystem::RenderParticles(const Matrix4x4& VP, const Vector3& CameraPos)
{
    /*
    m_billboardTechnique.Enable();
